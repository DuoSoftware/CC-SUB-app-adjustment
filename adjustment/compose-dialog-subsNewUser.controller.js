...
(function ()
{
  ...
  angular
    ...
    .controller('AddNewAdjUserController', AddNewAdjUserController);

  /** @ngInject */
  function AddNewAdjUserController($mdDialog, selectedMail, category, $scope, $mdToast, notifications, $charge)
  {
    var vm = this;
